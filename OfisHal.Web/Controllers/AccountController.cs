...
namespace OfisHal.Web.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public AccountController(Db db) => _db = db;
        ...
        public async Task<ActionResult> Login(LoginViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    var ticket = new FormsAuthenticationTicket(2, model.UserName, issueDateUtc, expirationUtc, model.RememberMe, $"{user.Id}|User", FormsAuthentication.FormsCookiePath);
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = await _db.Users.FirstOrDefaultAsync(u => u.UserName.Equals(model.UserName, StringComparison.CurrentCultureIgnoreCase));
