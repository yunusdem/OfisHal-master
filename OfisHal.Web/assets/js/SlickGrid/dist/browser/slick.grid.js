  ...
  var SlickGrid = class {
    ...
    createColumnHeaders() {
      ...
      for (let i = 0; i < this.columns.length; i++) {
        ...
        colNameElm.innerHTML = this.sanitizeHtmlString(m.name), Utils.width(header, m.width - this.headerColumnWidthDiff);
        ...
        if (!e.shiftKey && !e.altKey && !e.ctrlKey) {
          ...
          if (e.which === keyCode.ESCAPE) {
            ...
            this.cancelEditAndSetFocus();
                ...
                e.which === keyCode.PAGE_DOWN
                    ? (this.navigatePageDown(), (handled = !0))
                    : e.which === keyCode.PAGE_UP
                        ? (this.navigatePageUp(), (handled = !0))
                                    ...
                                    : e.which === keyCode.DOWN
                                        ...
                                        : e.which === keyCode.TAB
                                            ...
                                            (this._options.editable &&
                                                (this.currentEditor
                                                    ? this.activeRow === this.getDataLength()
                                                        ? this.navigateNext()
    ...
    commitEditAndSetFocus() {
      var _a;
        (_a = this.getEditorLock()) != null && _a.commitCurrentEdit() && (this.setFocus(), this._options.autoEdit && !this._options.autoCommitEdit && this.navigateNext());
    }
