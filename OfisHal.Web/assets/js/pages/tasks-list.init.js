/*
Template Name: OfisHal - Admin & Dashboard Template
Author: Themesbrand
...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function (raw) {
        ...
        tasksList.add({
            id: '<a href="TaskDetails" class="fw-medium link-primary">#VLZ' + raw.id + "</a>",
    ...
    tasksList.remove("id", `<a href="TaskDetails" class="fw-medium link-primary">#VLZ501</a>`);
}
    ...
    form.addEventListener('submit', function (event) {
        if (!form.checkValidity()) {
            ...
            if (
                ...
                tasksList.add({
                    id: '<a href="TaskDetails" class="fw-medium link-primary">#VLZ'+count+"</a>",
        ...
        Swal.fire({
            ...
            if (result.value) {
                for (i = 0; i < ids_array.length; i++) {
                    tasksList.remove("id", `<a href="TaskDetails" class="fw-medium link-primary">${ids_array[i]}</a>`);
                }
