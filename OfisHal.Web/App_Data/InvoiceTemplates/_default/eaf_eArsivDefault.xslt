							...
							<table border="1" id="lineTable" width="900">
								...
								<tr id="lineTableHeader">
									...
									<xsl:if test="//n1:Invoice/cbc:InvoiceTypeCode!='KOMISYONCU'">
										<th style="width:5%">Diğer Vergiler</th>
									</xsl:if>
									<th style="width:25%">Mal Hizmet Tutarı</th>
								</tr>
								<xsl:for-each select="n1:Invoice/cac:InvoiceLine">
									<tr>
										...
										<td align="right">
											...
											<!--<xsl:value-of select="format-number(./cbc:InvoicedQuantity, '###.##0,000', 'european')"/>-->
										</td>	
										<td align="center">													
