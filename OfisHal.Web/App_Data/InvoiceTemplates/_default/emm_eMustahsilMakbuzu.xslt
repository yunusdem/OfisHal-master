...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ccts="urn:un:unece:uncefact:documentation:2" xmlns:clm54217="urn:un:unece:uncefact:codelist:specification:54217:2001" xmlns:clm5639="urn:un:unece:uncefact:codelist:specification:5639:1988" xmlns:clm66411="urn:un:unece:uncefact:codelist:specification:66411:2001" xmlns:clmIANAMIMEMediaType="urn:un:unece:uncefact:codelist:specification:IANAMIMEMediaType:2003" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" xmlns:qdt="urn:oasis:names:specification:ubl:schema:xsd:QualifiedDatatypes-2" xmlns:udt="urn:un:unece:uncefact:data:specification:UnqualifiedDataTypesSchemaModule:2" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:lcl="http://www.efatura.gov.tr/local" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="cac cbc ccts clm54217 clm5639 clm66411 clmIANAMIMEMediaType fn link n1 qdt udt xbrldi xbrli xdt xlink xs xsd xsi lcl">
  ...
  <xsl:variable name="footerNote" select="//n1:CreditNote/cbc:Note[not(contains(.,'FOOTER2') or contains(.,'PLAKA'))]" />
  <xsl:template match="/">
    <html>
      <head>
      ...
      <body style="margin-left=0.6in; margin-right=0.6in; margin-top=0.79in; margin-bottom=0.79in">
          ...
          <table style="border-color:blue; " border="0" cellspacing="0px" width="900" cellpadding="0px">
            <tbody>
			  <tr valign="top">
                ...
                <td width="300" align="right" >
					...
					<div id="qrvalue" style="visibility: hidden; height: 20px; width: 20px; display:none">
						{"vkntckn":"<xsl:value-of select="n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID" />","avkntckn":"<xsl:value-of select="n1:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID" />","senaryo":"<xsl:value-of select="n1:CreditNote/cbc:ProfileID" />","tip":"<xsl:value-of select="n1:CreditNote/cbc:CreditNoteTypeCode" />","tarih":"<xsl:value-of select="n1:CreditNote/cbc:IssueDate" />","no":"<xsl:value-of select="n1:CreditNote/cbc:ID" />","ettn":"<xsl:value-of select="n1:CreditNote/cbc:UUID" />","parabirimi":"<xsl:value-of select="n1:CreditNote/cbc:DocumentCurrencyCode" />","malhizmettoplam":"<xsl:value-of select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:LineExtensionAmount" />","gvstopaj":"<xsl:for-each select="//n1:CreditNote/cac:TaxTotal/cac:TaxSubtotal"><xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='0003'"><xsl:value-of select="./cbc:TaxAmount" /></xsl:if></xsl:for-each>","merafonu":"0.00","borsatescilucreti":"<xsl:for-each select="//n1:CreditNote/cac:TaxTotal/cac:TaxSubtotal"><xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='8001'"><xsl:value-of select="./cbc:TaxAmount" /></xsl:if></xsl:for-each>","sgkprimkesintisi":"<xsl:for-each select="//n1:CreditNote/cac:TaxTotal/cac:TaxSubtotal"><xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='SGK_PRIM'"><xsl:value-of select="./cbc:TaxAmount" /></xsl:if></xsl:for-each>","odenecek":"<xsl:value-of select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:PayableAmount" />"}
					</div>
              ...
              <tr valign="top">
                <td width="300">
                  ...
                  <table align="center" border="0" width="100%">
                    <tbody>
                      ...
                      <xsl:if test="//n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telephone or //n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telefax">
                        <tr align="left">
                          <xsl:for-each select="n1:CreditNote/cac:AccountingSupplierParty/cac:Party">
                            <td align="left">
                      ...
                      <xsl:for-each select="//n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cbc:WebsiteURI">
                        <tr align="left">
                          <td>
                      ...
                      <xsl:for-each select="//n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:ElectronicMail">
                        <tr align="left">
                          <td>
                      ...
                      <xsl:for-each select="//n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification">
                        <tr align="left">
                          <td>
                ...
                <td id="signatureLogo" width="300" align="center" valign="middle">
                  <img style="width: 110px;" align="center" alt="Signature Image" src="" />
                </td>
                <td width="300" align="right" valign="top" colspan="2">
                  <table border="1" id="despatchTable">
                    <tbody>
                      ...
                      <xsl:for-each select="$footerNote">
                        <xsl:if test="contains(.,'Stok Giriş Tarihi')">
                          <tr style="height:13px; ">
                            <td align="left">
                              <span style="font-weight:bold; ">
                                <xsl:text>Stok Giriş Tarihi:</xsl:text>
                              </span>
                            </td>
                            <td align="left">
                              <xsl:value-of select="substring-after(//n1:CreditNote/cbc:Note[contains(.,'Stok Giriş Tarihi')],':')" />
                            </td>
                          </tr>
                        </xsl:if>
                      </xsl:for-each>
                      ...
                      <!--	<xsl:for-each select="n1:CreditNote/cac:AdditionalDocumentReference"> -->
                      <tr style="height:13px; ">
                        <td align="left">
                          <span style="font-weight:bold; ">
                        ...
                        <td align="left">
                          <xsl:value-of select="n1:CreditNote/cac:DespatchDocumentReference/cbc:ID" />
                        </td>
                      </tr>
                      <tr>
                        <td align="left">
                        ...
                        <td align="left">
                          <xsl:for-each select="n1:CreditNote/cac:DespatchDocumentReference/cbc:IssueDate">
                            <xsl:value-of select="substring(.,9,2)" />.<xsl:value-of select="substring(.,6,2)" />.<xsl:value-of select="substring(.,1,4)" /></xsl:for-each>
                        </td>
                      </tr>
                      <xsl:if test="n1:CreditNote/cac:AdditionalDocumentReference[cbc:DocumentType='Plaka']/cbc:ID">
                        <tr>
                          <td align="left">
                            <span style="font-weight:bold; ">
                          ...
                          <td align="left">
                            <xsl:value-of select="n1:CreditNote/cac:AdditionalDocumentReference[cbc:DocumentType='Plaka']/cbc:ID" />
                          </td>
                        </tr>
                      </xsl:if>
                    </tbody>
          ...
          <table border="1" id="lineTable" width="900">
            <tbody>
              <tr class="lineTableTr">
                ...
                <xsl:if test="//n1:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemIdentification/cbc:ID[@schemeID='KUNYENO']">
                  <th style="width:10%">Künye</th>
                </xsl:if>
                <xsl:if test="//n1:CreditNote/cac:CreditNoteLine/cbc:Note">
              ...
              <tr class="lineTableTr">
                ...
                <xsl:if test="//n1:CreditNote/cac:CreditNoteLine/cbc:Note">
                  <td align="center">
                    <xsl:if test="//n1:CreditNote/cbc:Note[contains(.,'Toplam Kap')]">
                      <span id="totalTable">
                        <xsl:value-of select="substring-after(//n1:CreditNote/cbc:Note[contains(.,'Toplam Kap    :')],':')" />
                      </span>
                    </xsl:if>
                  </td>
                  <td align="right">
                    <xsl:if test="//n1:CreditNote/cbc:Note[contains(.,'Toplam Dara')]">
                      <span id="totalTable">
                        <xsl:value-of select="substring-after(//n1:CreditNote/cbc:Note[contains(.,'Toplam Darali :')],':')" />
                      </span>
                    </xsl:if>
                  </td>
                  <td align="right">
                    <xsl:if test="//n1:CreditNote/cbc:Note[contains(.,'Toplam Darali')]">
                      <span id="totalTable">
                        <xsl:value-of select="substring-after(//n1:CreditNote/cbc:Note[contains(.,'Toplam Dara   :')],':')" />
                      </span>
                    </xsl:if>
                  </td>
                </xsl:if>
                <td align="right">
                  <xsl:if test="//n1:CreditNote/cbc:Note[contains(.,'Toplam Miktar')]">
                    <span id="totalTable">
                      <xsl:value-of select="substring-after(//n1:CreditNote/cbc:Note[contains(.,'Toplam Miktar :')],':')" />
                    </span>
                  </xsl:if>
                </td>
                <td>
        ...
        <table id="budgetContainerTable" width="900px">
          ...
          <tr align="right">
            ...
            <td class="lineTableBudgetTd" width="200px" align="right">
              <span style="font-weight:bold; ">
                <xsl:text>Makbuz Tutarı</xsl:text>
              </span>
            </td>
            <td class="lineTableBudgetTd" style="width:82px; " align="right">
          ...
          <xsl:if test="//n1:CreditNote/cbc:Note[contains(.,'İadeli Kap')]">
            <tr align="right">
              <td />
              <td class="lineTableBudgetTd" width="200px" align="right">
                <span style="font-weight:bold; ">
                  <xsl:text>İadeli Kap</xsl:text>
                </span>
              </td>
              <td class="lineTableBudgetTd" style="width:82px; " align="right">
                <xsl:value-of select="substring-after(//n1:CreditNote/cbc:Note[contains(.,'İadeli Kap')],':')" />
                <xsl:for-each select=".">
          ...
          <tr align="right">
            ...
            <td class="lineTableBudgetTd" width="200px" align="right">
              <span style="font-weight:bold; ">
                <xsl:text>Net Yekün</xsl:text>
              </span>
            </td>
            <td class="lineTableBudgetTd" style="width:82px; " align="right">
              <xsl:value-of select="substring-after(//n1:CreditNote/cbc:Note[contains(.,'Net Yekün')],':')" />
              <xsl:text> TL</xsl:text>
            </td>
          </tr>
          <xsl:for-each select="n1:CreditNote/cac:TaxTotal/cac:TaxSubtotal">
            <xsl:if test="//n1:CreditNote/cbc:DocumentCurrencyCode != 'TRY' and //n1:Cre/cbc:DocumentCurrencyCode != 'TRL'">
              <tr align="right">
                <td />
                <td class="lineTableBudgetTd" align="right" width="200px">
                  <span style="font-weight:bold; ">
                ...
                <td class="lineTableBudgetTd" style="width:81px; " align="right">
                  <span>
                    <xsl:value-of select="format-number(cbc:TaxAmount * //n1:CreditNote/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')" />
                    <xsl:text> TL</xsl:text>
                  </span>
                </td>
              </tr>
          ...
          <xsl:if test="//n1:CreditNote/cac:LegalMonetaryTotal/cbc:LineExtensionAmount/@currencyID != 'TRL' and //n1:CreditNote/cac:LegalMonetaryTotal/cbc:LineExtensionAmount/@currencyID != 'TRY'">
            <tr align="right">
              <td />
              <td class="lineTableBudgetTd" align="right" width="200px">
                <span style="font-weight:bold; ">
              ...
              <td class="lineTableBudgetTd" style="width:81px; " align="right">
                <xsl:value-of select="format-number(//n1:CreditNote/cac:LegalMonetaryTotal/cbc:LineExtensionAmount * //n1:CreditNote/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')" />
                <xsl:text> TL</xsl:text>
              </td>
            </tr>
            <tr align="right">
              ...
              <td class="lineTableBudgetTd" style="width:82px; " align="right">
                <xsl:value-of select="format-number(//n1:CreditNote/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount * //n1:CreditNote/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')" />
                <xsl:text> TL</xsl:text>
              </td>
            </tr>
            <tr align="right">
              ...
              <td class="lineTableBudgetTd" style="width:82px; " align="right">
                <xsl:value-of select="format-number(//n1:CreditNote/cac:LegalMonetaryTotal/cbc:PayableAmount * //n1:CreditNote/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')" />
                <xsl:text> TL</xsl:text>
              </td>
            </tr>
          </xsl:if>
        ...
        <table id="notesTable">
          ...
          <tr align="left">
            <td height="40">
              <b style="padding-left:100px;">Malı Satan</b>
              <br />
              <b style="padding-left:100px;">Ad Soyad TCKN</b>
              <br />
              <b style="padding-left:100px;">İmza</b>
              <br />
              <br />
              <br />
              <br />
  ...
  <xsl:template match="//n1:CreditNote/cac:CreditNoteLine">
    <tr class="lineTableTr">
      <td align="center" class="lineTableTd">
        <xsl:text> </xsl:text>
        <xsl:value-of select="./cbc:ID" />
      </td>
      ...
      <xsl:if test="//n1:CreditNote/cac:CreditNoteLine/cbc:Note">
        ...
        <td class="lineTableTd" align="right">
          ...
          <xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;
					<xsl:value-of select="$pDaralı" /><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;
			  </td>
        <td class="lineTableTd" align="right">
          <xsl:text> </xsl:text>
      ...
      <td class="lineTableTd" align="right">
        <xsl:text> </xsl:text>
        <xsl:value-of select="format-number(./cbc:CreditedQuantity, '###.##0,000', 'european')" />
      </td>
      <td align="center">
  ...
  <xsl:template name="Curr_Type_Only">
    <xsl:if test="n1:CreditNote/cac:LegalMonetaryTotal/cbc:PayableAmount/@currencyID">
      <xsl:text>
      </xsl:text>
      <xsl:choose>
        <xsl:when test="n1:CreditNote/cac:LegalMonetaryTotal/cbc:PayableAmount/@currencyID = 'TRL' or &#xD;&#xA;								n1:CreditNote/cac:LegalMonetaryTotal/cbc:PayableAmount/@currencyID = 'TRY'">
          <xsl:text>TL</xsl:text>
        </xsl:when>
        <xsl:otherwise>
          <xsl:value-of select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:PayableAmount/@currencyID" />
        </xsl:otherwise>
      </xsl:choose>
    </xsl:if>
  </xsl:template>
