  ...
  <xsl:variable name="footerNote" select="//n1:Invoice/cbc:Note[not(contains(.,'FOOTER2') or contains(.,'PLAKA'))]" />
	...
	<xsl:template match="/">
		<html>
		  ...
		  .allowanceChargeTable th{background-color: #FFFFFF;color:white;text-align:center;border-bottom: 1px solid #DCDCDB;font-weight: bold;height: 19px;padding-left: 4px;padding-right: 4px;}
          ...
          #budgetContainerTable th{background-color: #FFFFFF;text-align:left;border-bottom: 1px solid #DCDCDB;font-weight: bold;height: 19px;padding-left: 4px;padding-right: 4px;}
		  
		  .invoiceDetails{float:left; width:300px;}
		  .invoiceDetails .invoiceID{color:#000000;font-weight:bold;font-size: 15px;}
		  .invoiceDetails td{color:#000000 !important;font-weight:bold;white-space:nowrap; }
		  #invoiceDetailTbl {border-left: 15px solid black;}
		  ...
		  #hesapBilgileri table td{border: 1px solid gray; 
				...
				<xsl:if test="(//n1:Invoice/cbc:ProfileID='HKS')">
					<style>
						#lineTableHeader th{background-color:#000000;}
						.allowanceChargeTable th{background-color: #000000;}
						#budgetContainerTable th{background-color: #000000;}
						#hesapBilgileri table th{background-color:#000000;}
					</style>
				</xsl:if>
					...
					<table border="0" cellspacing="0px" width="900" cellpadding="0px">
						<tr class="containerTr">
							<td>
								<table>
									<tr>
										<td class="invoiceCustomer" width="300">
											<table>
											  <tr>
												<td>
												  <table style="border-color:#000000; " border="0" cellspacing="0px" width="300" cellpadding="0px">
													<tr>
													  <td width="38%">
															<br/>
															<table align="center" border="0" width="100%" style="margin-bottom: 5px;border: 1px solid #000000; border-left-width:5px; width:100%;padding:5px;">
																<tbody>
																	<tr align="left">
										...
										<td id="companyLogo" width="300" align="right" valign="middle">
										...
										<table id="customerPartyTable" align="left" border="0" height="50%">
											<tbody>
												<tr style="height:180px; ">
													<td>
														<table align="center" border="0" style="margin-bottom: 5px;border: 1px solid #000000; border-left-width:5px; width:100%;padding:5px;">
															<tbody>
...
-->
									<td width="300" align="center" valign="bottom">
									  ...
									  <div id="qrvalue" style="visibility: hidden">
										{
											"tur":"E-Fatura"
											,"VKNTCKN":"<xsl:value-of select="n1:Invoice/cac:Signature/cac:SignatoryParty/cac:PartyIdentification/cbc:ID"/>"
											,"plakano":"<xsl:value-of select="n1:Invoice/cac:AdditionalDocumentReference[cbc:DocumentType='Plaka']/cbc:ID"/>"
									...
									<td class="invoiceDetails" width="300">
									<table align="right">
											  ...
											  <xsl:for-each select="n1:Invoice/cac:WithholdingTaxTotal/cac:TaxSubtotal[starts-with(./cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode,'6')]">
												<tr>
													<th>																									
														...
														<xsl:value-of select="./cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode"/>)<xsl:text>(%</xsl:text>
