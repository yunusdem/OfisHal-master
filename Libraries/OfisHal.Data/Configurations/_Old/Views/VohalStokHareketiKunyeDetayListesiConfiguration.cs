...
{
    internal class VohalStokHareketiKunyeDetayListesiConfiguration : EntityTypeConfiguration<VohalStokHareketiKunyeDetayListesi>
    {
        public VohalStokHareketiKunyeDetayListesiConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_STOK_HAREKETI_KUNYE_DETAY_LISTESI");
