...
{
    internal class VohalMalKabulFaturalanmayanConfiguration : EntityTypeConfiguration<VohalMalKabulFaturalanmayan>
    {
        public VohalMalKabulFaturalanmayanConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_MAL_KABUL_FATURALANMAYAN");
            ...
            Property(e => e.MustahsilId).HasColumnName("MUSTAHSIL_ID");
            ...
            Property(e => e.MusteriId).HasColumnName("MUSTERI_ID");
