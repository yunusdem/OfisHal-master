...
{
    internal class VohalBuBeldeyeBagliOlmayanKayitsizMusterilerConfiguration : EntityTypeConfiguration<VohalBuBeldeyeBagliOlmayanKayitsizMusteriler>
    {
        public VohalBuBeldeyeBagliOlmayanKayitsizMusterilerConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_BU_BELDEYE_BAGLI_OLMAYAN_KAYITSIZ_MUSTERILER");
