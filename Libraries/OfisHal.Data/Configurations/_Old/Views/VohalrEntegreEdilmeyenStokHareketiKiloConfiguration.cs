...
{
    internal class VohalrEntegreEdilmeyenStokHareketiKiloConfiguration : EntityTypeConfiguration<VohalrEntegreEdilmeyenStokHareketiKilo>
    {
        public VohalrEntegreEdilmeyenStokHareketiKiloConfiguration()
        {
            //HasNoKey();

            ToTable("VOHALR_ENTEGRE_EDILMEYEN_STOK_HAREKETI_KILO");
