...
{
    internal class VohalrEntegreEdilmeyenFaturaSatiriConfiguration : EntityTypeConfiguration<VohalrEntegreEdilmeyenFaturaSatiri>
    {
        public VohalrEntegreEdilmeyenFaturaSatiriConfiguration()
        {
            //HasNoKey();

            ToTable("VOHALR_ENTEGRE_EDILMEYEN_FATURA_SATIRI");
