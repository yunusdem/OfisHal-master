...
{
    internal class VohalrKdvBazliAlisFaturasiListesiConfiguration : EntityTypeConfiguration<VohalrKdvBazliAlisFaturasiListesi>
    {
        public VohalrKdvBazliAlisFaturasiListesiConfiguration()
        {
            //HasNoKey();

            ToTable("VOHALR_KDV_BAZLI_ALIS_FATURASI_LISTESI");
