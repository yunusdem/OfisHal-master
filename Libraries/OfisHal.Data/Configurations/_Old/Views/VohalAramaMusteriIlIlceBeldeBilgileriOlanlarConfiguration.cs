...
{
    internal class VohalAramaMusteriIlIlceBeldeBilgileriOlanlarConfiguration : EntityTypeConfiguration<VohalAramaMusteriIlIlceBeldeBilgileriOlanlar>
    {
        public VohalAramaMusteriIlIlceBeldeBilgileriOlanlarConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_ARAMA_MUSTERI_IL_ILCE_BELDE_BILGILERI_OLANLAR");
