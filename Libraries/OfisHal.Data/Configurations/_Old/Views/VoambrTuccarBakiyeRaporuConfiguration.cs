...
{
    internal class VoambrTuccarBakiyeRaporuConfiguration : EntityTypeConfiguration<VoambrTuccarBakiyeRaporu>
    {
        public VoambrTuccarBakiyeRaporuConfiguration()
        {
            //HasNoKey();

            ToTable("VOAMBR_TUCCAR_BAKIYE_RAPORU");
