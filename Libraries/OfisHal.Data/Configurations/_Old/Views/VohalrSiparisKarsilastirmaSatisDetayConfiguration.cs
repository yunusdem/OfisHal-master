...
{
    internal class VohalrSiparisKarsilastirmaSatisDetayConfiguration : EntityTypeConfiguration<VohalrSiparisKarsilastirmaSatisDetay>
    {
        public VohalrSiparisKarsilastirmaSatisDetayConfiguration()
        {
            //HasNoKey();

            ToTable("VOHALR_SIPARIS_KARSILASTIRMA_SATIS_DETAY");
