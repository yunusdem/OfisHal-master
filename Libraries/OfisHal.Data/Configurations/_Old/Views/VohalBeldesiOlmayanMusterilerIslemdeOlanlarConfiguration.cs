...
{
    internal class VohalBeldesiOlmayanMusterilerIslemdeOlanlarConfiguration : EntityTypeConfiguration<VohalBeldesiOlmayanMusterilerIslemdeOlanlar>
    {
        public VohalBeldesiOlmayanMusterilerIslemdeOlanlarConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_BELDESI_OLMAYAN_MUSTERILER_ISLEMDE_OLANLAR");
