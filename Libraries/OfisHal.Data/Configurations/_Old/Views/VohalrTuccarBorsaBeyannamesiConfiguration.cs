...
{
    internal class VohalrTuccarBorsaBeyannamesiConfiguration : EntityTypeConfiguration<VohalrTuccarBorsaBeyannamesi>
    {
        public VohalrTuccarBorsaBeyannamesiConfiguration()
        {
            //HasNoKey();

            ToTable("VOHALR_TUCCAR_BORSA_BEYANNAMESI");
