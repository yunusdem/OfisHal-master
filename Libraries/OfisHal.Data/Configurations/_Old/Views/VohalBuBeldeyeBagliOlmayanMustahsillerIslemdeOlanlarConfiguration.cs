...
{
    internal class VohalBuBeldeyeBagliOlmayanMustahsillerIslemdeOlanlarConfiguration : EntityTypeConfiguration<VohalBuBeldeyeBagliOlmayanMustahsillerIslemdeOlanlar>
    {
        public VohalBuBeldeyeBagliOlmayanMustahsillerIslemdeOlanlarConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_BU_BELDEYE_BAGLI_OLMAYAN_MUSTAHSILLER_ISLEMDE_OLANLAR");
