...
{
    internal class VohalrMakbuzSatiriDegisiklikConfiguration : EntityTypeConfiguration<VohalrMakbuzSatiriDegisiklik>
    {
        public VohalrMakbuzSatiriDegisiklikConfiguration()
        {
            //HasNoKey();

            ToTable("VOHALR_MAKBUZ_SATIRI_DEGISIKLIK");
