...
{
    internal class VohalrSatisRusumRaporuConfiguration : EntityTypeConfiguration<VohalrSatisRusumRaporu>
    {
        public VohalrSatisRusumRaporuConfiguration()
        {
            //HasNoKey();

            ToTable("VOHALR_SATIS_RUSUM_RAPORU");
