...
{
    internal class VohalBeldesiOlmayanMustahsillerIslemdeOlanlarConfiguration : EntityTypeConfiguration<VohalBeldesiOlmayanMustahsillerIslemdeOlanlar>
    {
        public VohalBeldesiOlmayanMustahsillerIslemdeOlanlarConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_BELDESI_OLMAYAN_MUSTAHSILLER_ISLEMDE_OLANLAR");
