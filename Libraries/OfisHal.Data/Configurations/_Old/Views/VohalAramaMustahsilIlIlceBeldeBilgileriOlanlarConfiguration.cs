...
{
    internal class VohalAramaMustahsilIlIlceBeldeBilgileriOlanlarConfiguration : EntityTypeConfiguration<VohalAramaMustahsilIlIlceBeldeBilgileriOlanlar>
    {
        public VohalAramaMustahsilIlIlceBeldeBilgileriOlanlarConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_ARAMA_MUSTAHSIL_IL_ILCE_BELDE_BILGILERI_OLANLAR");
