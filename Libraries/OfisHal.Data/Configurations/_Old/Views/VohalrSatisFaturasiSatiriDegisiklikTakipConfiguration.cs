...
{
    internal class VohalrSatisFaturasiSatiriDegisiklikTakipConfiguration : EntityTypeConfiguration<VohalrSatisFaturasiSatiriDegisiklikTakip>
    {
        public VohalrSatisFaturasiSatiriDegisiklikTakipConfiguration()
        {
            //HasNoKey();

            ToTable("VOHALR_SATIS_FATURASI_SATIRI_DEGISIKLIK_TAKIP");
