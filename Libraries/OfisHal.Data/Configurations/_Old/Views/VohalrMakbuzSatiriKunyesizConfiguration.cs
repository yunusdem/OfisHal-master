...
{
    internal class VohalrMakbuzSatiriKunyesizConfiguration : EntityTypeConfiguration<VohalrMakbuzSatiriKunyesiz>
    {
        public VohalrMakbuzSatiriKunyesizConfiguration()
        {
            //HasNoKey();

            ToTable("VOHALR_MAKBUZ_SATIRI_KUNYESIZ");
