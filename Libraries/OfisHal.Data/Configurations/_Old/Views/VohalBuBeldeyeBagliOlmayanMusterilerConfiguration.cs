...
{
    internal class VohalBuBeldeyeBagliOlmayanMusterilerConfiguration : EntityTypeConfiguration<VohalBuBeldeyeBagliOlmayanMusteriler>
    {
        public VohalBuBeldeyeBagliOlmayanMusterilerConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_BU_BELDEYE_BAGLI_OLMAYAN_MUSTERILER");
