...
{
    internal class VohalBeldesiOlmayanMustahsillerConfiguration : EntityTypeConfiguration<VohalBeldesiOlmayanMustahsiller>
    {
        public VohalBeldesiOlmayanMustahsillerConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_BELDESI_OLMAYAN_MUSTAHSILLER");
