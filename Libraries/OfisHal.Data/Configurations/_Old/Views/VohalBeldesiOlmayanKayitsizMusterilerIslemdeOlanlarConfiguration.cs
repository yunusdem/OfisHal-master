...
{
    internal class VohalBeldesiOlmayanKayitsizMusterilerIslemdeOlanlarConfiguration : EntityTypeConfiguration<VohalBeldesiOlmayanKayitsizMusterilerIslemdeOlanlar>
    {
        public VohalBeldesiOlmayanKayitsizMusterilerIslemdeOlanlarConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_BELDESI_OLMAYAN_KAYITSIZ_MUSTERILER_ISLEMDE_OLANLAR");
