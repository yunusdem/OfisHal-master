...
{
    internal class VoambrAmbarKesintiRaporuConfiguration : EntityTypeConfiguration<VoambrAmbarKesintiRaporu>
    {
        public VoambrAmbarKesintiRaporuConfiguration()
        {
            //HasNoKey();

            ToTable("VOAMBR_AMBAR_KESINTI_RAPORU");
