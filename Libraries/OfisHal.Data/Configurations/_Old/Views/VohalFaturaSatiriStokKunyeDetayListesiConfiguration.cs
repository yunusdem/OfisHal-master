...
{
    internal class VohalFaturaSatiriStokKunyeDetayListesiConfiguration : EntityTypeConfiguration<VohalFaturaSatiriStokKunyeDetayListesi>
    {
        public VohalFaturaSatiriStokKunyeDetayListesiConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_FATURA_SATIRI_STOK_KUNYE_DETAY_LISTESI");
