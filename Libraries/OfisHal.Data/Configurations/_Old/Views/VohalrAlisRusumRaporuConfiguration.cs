...
{
    internal class VohalrAlisRusumRaporuConfiguration : EntityTypeConfiguration<VohalrAlisRusumRaporu>
    {
        public VohalrAlisRusumRaporuConfiguration()
        {
            //HasNoKey();

            ToTable("VOHALR_ALIS_RUSUM_RAPORU");
