...
{
    internal class VohksDokumSatiriIstekConfiguration : EntityTypeConfiguration<VohksDokumSatiriIstek>
    {
        public VohksDokumSatiriIstekConfiguration()
        {
            //HasNoKey();

            ToTable("VOHKS_DOKUM_SATIRI_ISTEK");
            ...
            Property(e => e.HksUlkeId).HasColumnName("HKS_ULKE_ID");
