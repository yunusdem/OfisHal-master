...
{
    internal class VohalrCekListesiConfiguration : EntityTypeConfiguration<VohalrCekListesi>
    {
        public VohalrCekListesiConfiguration()
        {
            //HasNoKey();

            ToTable("VOHALR_CEK_LISTESI");
            ...
            Property(e => e.CiroEdilen)
                .IsRequired()
                .HasMaxLength(200)
                .IsUnicode(false)
                .HasColumnName("CIRO_EDILEN");
