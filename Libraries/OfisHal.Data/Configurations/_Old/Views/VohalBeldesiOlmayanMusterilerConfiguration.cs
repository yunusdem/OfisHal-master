...
{
    internal class VohalBeldesiOlmayanMusterilerConfiguration : EntityTypeConfiguration<VohalBeldesiOlmayanMusteriler>
    {
        public VohalBeldesiOlmayanMusterilerConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_BELDESI_OLMAYAN_MUSTERILER");
