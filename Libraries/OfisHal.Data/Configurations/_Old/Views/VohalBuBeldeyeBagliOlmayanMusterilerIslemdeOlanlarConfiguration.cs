...
{
    internal class VohalBuBeldeyeBagliOlmayanMusterilerIslemdeOlanlarConfiguration : EntityTypeConfiguration<VohalBuBeldeyeBagliOlmayanMusterilerIslemdeOlanlar>
    {
        public VohalBuBeldeyeBagliOlmayanMusterilerIslemdeOlanlarConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_BU_BELDEYE_BAGLI_OLMAYAN_MUSTERILER_ISLEMDE_OLANLAR");
