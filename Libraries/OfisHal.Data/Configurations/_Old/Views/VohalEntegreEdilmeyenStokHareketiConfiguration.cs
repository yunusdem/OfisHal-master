...
{
    internal class VohalEntegreEdilmeyenStokHareketiConfiguration : EntityTypeConfiguration<VohalEntegreEdilmeyenStokHareketi>
    {
        public VohalEntegreEdilmeyenStokHareketiConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_ENTEGRE_EDILMEYEN_STOK_HAREKETI");
