...
{
    internal class VohalrYuklemeNakliyeRaporuConfiguration : EntityTypeConfiguration<VohalrYuklemeNakliyeRaporu>
    {
        public VohalrYuklemeNakliyeRaporuConfiguration()
        {
            //HasNoKey();

            ToTable("VOHALR_YUKLEME_NAKLIYE_RAPORU");
