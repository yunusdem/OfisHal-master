...
{
    internal class Vohal00AlisFaturasiConfiguration : EntityTypeConfiguration<Vohal00AlisFaturasi>
    {
        public Vohal00AlisFaturasiConfiguration()
        {
            //HasNoKey();

            ToTable("VOHAL_00_ALIS_FATURASI");
