...
{
    internal class VohalGonderimeHazirEFaturaConfiguration : EntityTypeConfiguration<VohalGonderimeHazirEFatura>
    {
        public VohalGonderimeHazirEFaturaConfiguration()
        {
            HasKey(e => e.FaturaId);
            //HasNoKey();

            ToTable("VOHAL_GONDERIME_HAZIR_E_FATURA");
