...
{
    internal class VohalFaturaSatiriUrtConfiguration : EntityTypeConfiguration<VohalFaturaSatiriUrt>
    {
        public VohalFaturaSatiriUrtConfiguration()
        {
            HasKey(e => e.FaturaSatiriId);
            //HasNoKey();
            
            ToTable("VOHAL_FATURA_SATIRI_URT");
