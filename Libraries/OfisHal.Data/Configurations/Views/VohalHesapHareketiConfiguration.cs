...
{
    internal class VohalHesapHareketiConfiguration : EntityTypeConfiguration<VohalHesapHareketi>
    {
        public VohalHesapHareketiConfiguration()
        {
            //HasNoKey();
            HasKey(x => x.HesapHareketiId);
            ToTable("VOHAL_HESAP_HAREKETI");
