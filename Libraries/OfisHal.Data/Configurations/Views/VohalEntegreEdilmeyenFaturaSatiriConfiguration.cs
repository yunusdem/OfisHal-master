...
{
    internal class VohalEntegreEdilmeyenFaturaSatiriConfiguration : EntityTypeConfiguration<VohalEntegreEdilmeyenFaturaSatiri>
    {
        public VohalEntegreEdilmeyenFaturaSatiriConfiguration()
        {
            HasKey(e => e.FaturaSatiriId);

            ToTable("VOHAL_ENTEGRE_EDILMEYEN_FATURA_SATIRI");
